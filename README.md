...
| Open the end-to-end automation diagram | [Workflow automation map](#workflow-automation-map) |
...
- [System architecture](docs/QMS-Lite-System-Architecture.md) and [workflow automation map](#workflow-automation-map) for the training workflow model
...
- [Workflow automation map](#workflow-automation-map)
