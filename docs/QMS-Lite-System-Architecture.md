...
| `qms_content_guard.yml` | `pull_request` | Enforces revision-history, README navigation/index, training-matrix synchronization, and configured record-index sanity checks for controlled content changes. | Active |
