...
The public repository is an open-source baseline. Hosted-service incidents or adopter-specific deployment issues may require separate handling outside the repository itself.
