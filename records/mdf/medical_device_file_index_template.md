...
|---|---|---|---|---|---|---|
| Intended use and claims | `docs/regulatory/intended_use.md` | `R03` | approved | Gate 1 baseline | regulatory_lead | Controlled intended use, users, use environment, and claims |
| Device description | `records/mdf/device_description.md` | `R02` | approved | Gate 1 baseline | engineering_lead + regulatory_lead | Product overview, major subsystems, interfaces, variants, and accessories |
| Classification and pathway | `records/mdf/classification_decision.md` | `R01` | approved | Gate 1 baseline | regulatory_lead | Distinct from IEC 62304 software safety classification |
...
| Risk management plan | `records/risk/risk_management_plan.md` | `R01` | approved | Gate 1 baseline | regulatory_lead | Defines methods, scoring, review cadence, and responsibilities |
| Risk file and reviews | `records/risk/risk_register.md`, `records/risk/risk_management_review.md` | `R05` / `R02` | current | Gate 2 / Gate 3 | engineering_lead + regulatory_lead | Current hazard, failure-mode, and residual-risk state |
...
| Declaration of conformity | `records/mdf/declaration_of_conformity.md` | `R00` | draft until placed on market | release package | regulatory_lead | Signed only for the placed-on-market configuration and jurisdictions in scope |
...
| Post-market and quality follow-up links | `records/feedback/`, `records/pms/`, `records/incidents/`, `records/capas/` | current | ongoing | post-release | qa_lead + regulatory_lead | Linked lifecycle records, not Gate 1 baseline artifacts |
