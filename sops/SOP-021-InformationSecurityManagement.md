...
---
## 1. Purpose
Define the Information Security Management System (ISMS) procedure used to protect QMS records, product information, regulated software lifecycle evidence, supplier interfaces, and operational systems. This procedure aligns the GitHub-native QMS operating model with ISO/IEC 27001:2022, including ISO/IEC 27001:2022/Amd 1:2024, while reusing the existing QMS controls for document control, competence, suppliers, infrastructure, audit, management review, CAPA, software lifecycle control, and record retention.
...
### 6.1 Establish and Approve ISMS Scope and Context
1. Define the ISMS scope for the GitHub-native QMS, associated product/study repositories, signature tooling, controlled release assets, supplier systems that store or process QMS/product information, and supporting operational infrastructure.
2. Identify internal and external issues, interested-party information security requirements, and whether climate change is relevant to ISMS outcomes, availability expectations, supplier dependencies, infrastructure resilience, or interested-party requirements.
3. Record the scope and context in the ISMS register or equivalent controlled record, including owner, review cadence, approval reference, and next review due date.
4. Obtain Management Representative approval before treating the ISMS scope or context baseline as effective.

### 6.2 Maintain Asset Inventory and Security Context
1. Record information assets at a level sufficient to identify owner, repository or system, information type, confidentiality/integrity/availability expectations, supplier dependency, and control evidence location.
2. Add or update assets when repositories, signing components, workflows, suppliers, infrastructure, secrets, product repositories, or runtime systems are introduced or materially changed.
3. Maintain product-specific security assets and runtime controls in the designated product repository and link them from the product dossier.

### 6.3 Assess and Treat Information Security Risks
...
3. Select a treatment decision of mitigate, avoid, transfer, or accept. Risk acceptance requires Management Representative approval and an expiry or review trigger.
4. Route product safety or clinical-impact security risks into product risk management under `SOP-018` when the security risk can affect safety, performance, clinical evidence, or regulatory commitments.

### 6.4 Maintain the Statement of Applicability
1. Maintain a Statement of Applicability that accounts for the complete ISO/IEC 27001:2022 Annex A control set before approval.
...
### 6.5 Operate GitHub-Native Security Controls
...
### 6.6 Triage Security Events, Vulnerabilities, and Incidents
...
### 6.7 Collect Control Evidence
1. Plan evidence collection when controls require tool-assisted, manual, or supplier-provided evidence.
2. Record selected collectors, manual checks, authentication model, expected outputs, known limitations, normalization method, raw artifact hashes, control results, and follow-up decisions.
3. Link evidence run reports to the SoA controls, ISMS risks, access reviews, supplier records, change records, or CAPAs they support.

### 6.8 Review Effectiveness and Route Improvements
1. Monitor ISMS effectiveness through access-review completion, overdue security risk treatments, vulnerability response timeliness, supplier security review status, incident trends, audit findings, failed or bypassed control signals, and evidence collection results.
2. Review ISMS scope, context, risk treatment, and SoA at least quarterly and whenever a material repository, supplier, product, workflow, infrastructure, standard, interested-party requirement, or regulatory change occurs.
3. Include ISMS inputs in governance review, internal audit planning, management review, and CAPA when thresholds are missed or recurring issues are detected.
4. Route required improvements through CAPA, change management, supplier control, product risk management, software lifecycle control, or management review according to the affected process.
