...
2. Implement usability record updates through pull requests that include either linked issue context or sufficient change context in the PR, plus the required Part 11 signature meaning/roles.
