...
Baseline operational windows:

| Process | Maximum Window | Record |
|---|---|---|
| Personal data breach assessment | Complete initial risk and notification decision within 24 hours of awareness. | Personal data breach register |
| Controller notification by processor | Notify immediately and no later than 48 hours from awareness, unless contract or law requires a shorter window. | Personal data breach register or controller notification record |
| Data-subject rights request resolution | Resolve within 30 calendar days of receipt or verified identity, unless applicable law permits or requires a different documented timeline. | Data-subject request log |

Where applicable law, customer contract, or authority instruction requires a shorter window, the shorter window controls.
